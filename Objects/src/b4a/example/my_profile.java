...
public class my_profile extends Activity implements B4AActivity{
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		if (isFirst) {
			processBA = new BA(this.getApplicationContext(), null, null, "b4a.example", "b4a.example.my_profile");
	...
	private void afterFirstLayout() {
        if (this != mostCurrent)
			return;
		activityBA = new BA(this, layout, processBA, "b4a.example", "b4a.example.my_profile");
        ...
        if (BA.isShellModeRuntimeCheck(processBA)) {
			...
			processBA.raiseEvent2(null, true, "CREATE", true, "b4a.example.my_profile", processBA, activityBA, _activity, anywheresoftware.b4a.keywords.Common.Density, mostCurrent);
...
public static String  _activity_create(boolean _firsttime) throws Exception{
 ...
 //BA.debugLineNum = 25;BA.debugLine="Activity.LoadLayout(\"my_profile\")";
mostCurrent._activity.LoadLayout("my_profile",mostCurrent.activityBA);
 //BA.debugLineNum = 27;BA.debugLine="Dim Panel1 As Panel";
mostCurrent._panel1 = new anywheresoftware.b4a.objects.PanelWrapper();
 //BA.debugLineNum = 29;BA.debugLine="Panel1.Width = Activity.Width";
mostCurrent._panel1.setWidth(mostCurrent._activity.getWidth());
 //BA.debugLineNum = 30;BA.debugLine="Panel1.Height = Activity.Height";
mostCurrent._panel1.setHeight(mostCurrent._activity.getHeight());
 //BA.debugLineNum = 31;BA.debugLine="Panel1.Color = Colors.Red";
mostCurrent._panel1.setColor(anywheresoftware.b4a.keywords.Common.Colors.Red);
...
public static String  _button1_click() throws Exception{
 ...
 //BA.debugLineNum = 46;BA.debugLine="StartActivity (\"menu_frame\")";
anywheresoftware.b4a.keywords.Common.StartActivity(mostCurrent.activityBA,(Object)("menu_frame"));
 //BA.debugLineNum = 48;BA.debugLine="End Sub";
return "";
}
public static String  _globals() throws Exception{
 //BA.debugLineNum = 12;BA.debugLine="Sub Globals";
 //BA.debugLineNum = 15;BA.debugLine="Activity.LoadLayout (\"my_profile\")";
mostCurrent._activity.LoadLayout("my_profile",mostCurrent.activityBA);
...
mostCurrent._imageview1 = new anywheresoftware.b4a.objects.ImageViewWrapper();
 //BA.debugLineNum = 18;BA.debugLine="Dim ImageView3 As ImageView";
